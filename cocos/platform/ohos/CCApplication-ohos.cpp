...
{
    std::string languageName = "zh"; // TBD need fixed getCurrentLanguageJNI();
...
{
    return "";//TBD need fixed JniHelper::callStaticStringMethod(helperClassName, "getVersion");
}

bool Application::openURL(const std::string &url)
{
    return "";//TBD need fixed JniHelper::callStaticBooleanMethod(helperClassName, "openURL", url);
}
